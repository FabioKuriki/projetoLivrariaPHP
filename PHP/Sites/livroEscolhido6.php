...
<body style="background-color: black">
    ...
    <div class="card container-fluid" style="width: 80rem; margin-top: 2%; padding: 2%">
        <div class="row">
            <div class="col">
                <img src="../Imagens/livro6.jpg" class="card-img-top img-fluid" alt="...">
            </div>
            <div class="col">
                <h5 class="card-title">Caminho Suave</h5>
                <p style="text-align: justify" class="card-text">Em sua surpreendente 133ª edição, a 
                    Cartilha Caminho Suave continua a apresentar o consagrado método de alfabetização 
                    brilhantemente desenvolvido por Branca Alves de Lima, amplamente adotado por 
                    professores das redes pública e privada.
                    Este grande sucesso conduz a alfabetização de maneira simples e inteligente!
                    É ideal para facilitar o caminho de crianças, jovens e adultos pelo mundo das letras 
                    – tanto como método principal quanto como material de apoio a outros métodos.
                    Ricamente ilustrado, este material garante o êxito da alfabetização pela imagem, 
                    método já testado e aprovado por mais de 40 milhões de brasileiros.</p>
            </div>
            ...
            <form method="POST">
                ...
                <?php
                    if(isset($_POST["cartao"])){
                        $cartao = $_POST["cartao"];
                        $inserir->realizarCompra($conexao, $cartao, '23165', 6);
                    }
                ?>
                </button>
            </form>
