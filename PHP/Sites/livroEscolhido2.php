...
<body style="background-color: black">
    ...
    <div class="card container-fluid" style="width: 80rem; margin-top: 2%; padding: 2%">
        <div class="row">
            <div class="col">
                <img src="../Imagens/livro2.jpg" class="card-img-top img-fluid" alt="...">
            </div>
            <div class="col">
                <h5 class="card-title fw-bold">Clássicos Góticos</h5>
                <p style="text-align: justify" class="card-text">Obras essenciais da literatura gótica: 
                    Drácula de Bram Stoker, Frankenstein de Mary Shelley, O Retrato de Dorian Gray de 
                    Oscar Wilde e O Fantasma da Ópera de Gaston Leroux. Com cenários medievais, 
                    personagens melodramáticos, desconfortos psicológicos, como medo e loucura, 
                    estão presentes nessas narrativas.</p>
            </div>
            ...
            <form method="POST">
                ...
                <?php
                    if(isset($_POST["cartao"])){
                        $cartao = $_POST["cartao"];
                        $inserir->realizarCompra($conexao, $cartao, '23165', 2);
                    }
                ?>
                </button>
            </form>
