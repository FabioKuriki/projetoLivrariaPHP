...
<body style="background-color: black">
    ...
    <div class="card container-fluid" style="width: 80rem; margin-top: 2%; padding: 2%">
        <div class="row">
            <div class="col">
                <img src="../Imagens/livro3.jpg" class="card-img-top img-fluid" alt="...">
            </div>
            <div class="col">
                <h5 class="card-title fw-bold">A Revolução dos Bichos</h5>
                <p style="text-align: justify" class="card-text">A obra-prima de George Orwell adaptada para os quadrinhos. 
                    Clássico moderno, A revolução dos bichos ganha vida e movimento no traço do gaúcho Odyr. 
                    Ao narrar a insurreição dos animais de uma granja contra seus donos, a obra mostra como o 
                    conflito os leva a uma tirania ainda mais opressiva que a dos humanos.</p>
            </div>
            ...
            <form method="POST">
                ...
                <?php
                    if(isset($_POST["cartao"])){
                        $cartao = $_POST["cartao"];
                        $inserir->realizarCompra($conexao, $cartao, '23165', 3);
                    }
                ?>
                </button>
            </form>
